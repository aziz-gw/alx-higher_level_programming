...
Python
    ...
    Weight: 1
    Project over - took place from Aug 10, 2023 6:00 AM to Aug 12, 2023 6:00 AM
    An auto review will be launched at the deadline

In a nutshell…

    Auto QA review: 85.0/85 mandatory & 27.0/58 optional
    Altogether:  146.55%
        Mandatory: 100.0%
        Optional: 46.55%
        Calculation:  100.0% + (100.0% * 46.55%)  == 146.55%
