...
PythonOOPSQLMySQLORMSQLAlchemy
    ...
    Weight: 1
    Project over - took place from Nov 16, 2023 6:00 AM to Nov 20, 2023 6:00 AM
    An auto review will be launched at the deadline

In a nutshell…

    Auto QA review: 134.55/165 mandatory & 0.0/32 optional
    Altogether:  81.55%
        Mandatory: 81.55%
        Optional: 0.0%
        Calculation:  81.55% + (81.55% * 0.0%)  == 81.55%
